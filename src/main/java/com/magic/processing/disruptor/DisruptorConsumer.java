 ...
 * 消费者线程
 */
public abstract class DisruptorConsumer implements WorkHandler<DisruptorEvent>, EventHandler<DisruptorEvent>, LifecycleAware {

    private static Logger logger = LoggerFactory.getLogger(DisruptorConsumer.class);
    ...
    @Override
    public void onEvent(DisruptorEvent t, long sequence, boolean b) throws Exception {
        onEvent(t);
    }
     ...
     */
    @Override
    public void onEvent(DisruptorEvent context) throws Exception {
     ...
     * @param data
     */
    public abstract void doRunner(String id, Object data) throws Exception;
